												...
												foreach ($sql1->result_array() as $data) { ?>
													<tr>
														...
														<td style="text-align:center;">
															...
															<a onclick="return konfirmasi()" href=<?= base_url('admin/delete_arsip_suratkeluar') ?>?id_arsipkeluar=<?= $data['id_arsipkeluar'] ?>><button type="button" title="Hapus" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i></button></a>
														</td>
													</tr>
												<?php }
												?>
